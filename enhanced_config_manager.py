...
class ConfigSchema:
    ...
    def get_module_schema(module_name: str) -> Dict[str, Any]:
        ...
        schemas = {
            ...
            # Used by: category_lookup_module.py, category_hierarchy_service.py,
            #          element_id_lookup_module.py
            # Controls: Category database and element ID lookup settings
            # =================================================================
            ModuleConfig.PIECE_IDENTIFIER.value: {
                ...
                "element_id_lookup_path": "./element_id_lookup.csv"  # Generated by tools/database_update_tool
            },
